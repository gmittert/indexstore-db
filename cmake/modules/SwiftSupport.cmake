...
function(add_swift_library library)
  ...
  add_custom_command(TARGET ${library} POST_BUILD
    ...
    "${CMAKE_CURRENT_BINARY_DIR}/${library}.dll"
    "${CMAKE_BINARY_DIR}/bin/${library}.dll")

  add_custom_command(TARGET ${library} POST_BUILD
    COMMAND ${CMAKE_COMMAND} -E copy_if_different
    "${CMAKE_CURRENT_BINARY_DIR}/${library}.lib"
    "${CMAKE_BINARY_DIR}/lib/${library}.lib")
endfunction()
...
function(add_swift_executable executable)
  ...
  add_custom_command(TARGET ${executable} POST_BUILD
    ...
    "${CMAKE_BINARY_DIR}/bin/${executable}.exe")
endfunction()
